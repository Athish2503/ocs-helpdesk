...
import { getUserById, createUser, getAgents, } from "./users.service.js";
describe("Users Service - Business Logic & Edge Cases", () => {
    ...
    it("createUser should throw 409 if email already exists", async () => {
        ...
        await expect(createUser({ name: "Existing", email: "existing@example.com", password: "pwd", role: "CUSTOMER" })).rejects.toMatchObject({
            statusCode: 409,
