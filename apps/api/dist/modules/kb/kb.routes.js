...
import { listArticlesHandler, getArticleByIdOrSlugHandler, createArticleHandler, updateArticleHandler, deleteArticleHandler, listCategoriesHandler, createCategoryHandler, updateCategoryHandler, deleteCategoryHandler, listTagsHandler, listVersionsHandler, recordArticleReadHandler, getArticleAnalyticsHandler, getArticleSEOHandler, updateArticleSEOHandler, listSecurityEventsHandler, uploadKBImageHandler, listAttachmentsHandler, deleteAttachmentHandler, setFeaturedImageHandler, reorderAttachmentsHandler, promoteTicketToKbHandler, getPublicSitemapHandler, getPublicArticleBySlugHandler, getArticleSuggestionsHandler, } from "./kb.controller.js";
import { requireAuth } from "../../middleware/auth.middleware.js";
import { requireRole } from "../../middleware/role.middleware.js";
import { verifyAccessToken } from "../../utils/jwt.js";
import { uploadKBImage } from "../../middleware/uploadMiddleware.js";
import { publicSecurityMiddleware, logPublicAccess, validateSlug, } from "../../middleware/publicSecurity.js";
/**
...
router.get("/public/articles/:slug", publicSecurityMiddleware(), logPublicAccess, validateSlug, getPublicArticleBySlugHandler);
router.post("/public/articles/:articleId/read", publicSecurityMiddleware(), recordArticleReadHandler);
// --- ARTICLE ROUTING ---
...
router.post("/articles/:articleId/attachments", requireAuth, requireRole("ADMIN", "AGENT"), uploadKBImage.single("file"), uploadKBImageHandler);
...
router.post("/articles/:articleId/attachments/:attachmentId/featured", requireAuth, requireRole("ADMIN", "AGENT"), setFeaturedImageHandler);
