...
import { listArticles, getArticleById, createArticle, } from "./kb.service.js";
describe("Knowledge Base Service - Business Logic & Edge Cases", () => {
    ...
    it("listArticles for CUSTOMER role should only return published public articles", async () => {
        prisma.user.findUnique.mockResolvedValue({ crmCustomerId: null });
    ...
    it("createArticle should create article with generated unique slug", async () => {
        ...
        prisma.knowledgeBaseArticleVersion.create.mockResolvedValue({});
        const article = await createArticle({ title: "How to configure DNS", content: "Steps..." }, "author1");
