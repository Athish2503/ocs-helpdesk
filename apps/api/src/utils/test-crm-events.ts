...
import { enqueueEvent, processQueueAsync } from "../services/crm-queue.service.js";
import { getOrFetchDomains, CrmCacheManager } from "../services/crm-cache.service.js";
import * as crmService from "../services/crm.service.js";

// CRM mock responses dictionary
const mockCrmResponses: Record<string, any> = {
