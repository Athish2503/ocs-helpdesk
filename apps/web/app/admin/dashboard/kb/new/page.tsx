...
import { ChevronLeft, Save, Globe, Eye, Sparkles, Sliders, FileText } from "lucide-react";
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(resData.error?.message || "Failed to create article.");
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-4 sm:p-6 lg:p-8 text-slate-800 dark:text-slate-100">
      ...
      <div className="max-w-4xl mx-auto mb-6 flex flex-wrap justify-between items-center gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-extrabold tracking-tight">Create KB Article</h1>
            <p className="text-xs text-slate-400">Write a new knowledge base draft or documentation guide</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-1 flex flex-col gap-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900 rounded-2xl p-4 text-xs text-blue-600 dark:text-blue-400 font-medium">
            <span className="font-bold flex items-center gap-1 mb-1">
              <Sparkles size={12} /> Image Uploads Note
            </span>
            Once you save this article draft, you will be able to upload screenshots and drag-and-drop assets into your workspace.
          </div>
        </div>
      </div>
    </div>
